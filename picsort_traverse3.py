# Picture sorting script that uses exif data from images
# Exif data is then use to create folders based on month/year picture taken
# Images are then move to their respective files
